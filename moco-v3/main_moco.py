...
def main_worker(gpu, ngpus_per_node, args):
    ...
    augment_train_loader, normal_train_loarder, normal_test_loader = DL2425_init.get_data(args)
    
    for epoch in range(args.start_epoch, args.epochs):

        # train for one epoch
        train(augment_train_loader, model, optimizer, scaler, summary_writer, epoch, args)
    ...
    DL2425_linear_probing.execute_lb_and_validate(model, normal_train_loarder, normal_test_loader, args)
